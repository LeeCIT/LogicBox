...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Awesome, intuitive and efficient logic gate simulation.">
    <meta name="author" content="">
    <link rel="shortcut icon" href="favicon.ico">

    <title>@yield('title', 'LogicBox - Awesome logic gate simulation for free')</title>
	...
	<script>
	  ...
	  ga('create', 'UA-50848050-1', 'logicbox.info');
	  ga('send', 'pageview');
	</script>
  </head>
